...
const DetailsPopup: React.FC<DetailsPopupProps> = ({
  ...
  let total =
    BASE_PRICE + numWaiters * WAITER_PRICE + numBartenders * BARTENDER_PRICE;
      ...
      <div className={`${styles.popupContent} ${styles.scrollableContent}`}>
        ...
        <div className={styles.detailsSection}>
          ...
          <div className={styles.detailsRow}>
            <span>Waiters</span>
            <span>
              {numWaiters} × ₹{WAITER_PRICE} = ₹{numWaiters * WAITER_PRICE}
            </span>
          </div>
          <div className={styles.detailsRow}>
            <span>Bartenders</span>
            <span>
              {numBartenders} × ₹{BARTENDER_PRICE} = ₹
              {numBartenders * BARTENDER_PRICE}
            </span>
          </div>
          <div
            ...
            <span>
              ₹{numWaiters * WAITER_PRICE + numBartenders * BARTENDER_PRICE}
            </span>
          </div>
        </div>
        ...
        <div
          className={styles.detailsRow}
          style={{ fontWeight: 700, color: "#111", fontSize: 18 }}>
          <h3>Base Price:</h3>
        ...
        <div
          ...
          <div className={styles.totalRow}>
            <span style={{ fontWeight: 700, fontSize: 22, color: "#111" }}>
              Total Amount
            </span>
            {couponApplied ? (
              <span>
                ...
                <span
                  style={{ color: "#ff4d4f", fontWeight: 700, fontSize: 22 }}>
                  ₹{finalTotal}
                </span>
              </span>
            ) : (
          ...
          <div
            ...
            The booking fee of ₹{BOOKING_FEE} will be deducted from your final
            bill
          </div>
          {/* <div style={{
            color: '#219653',
